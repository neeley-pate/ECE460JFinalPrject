...
def sampleImages(digital_image_samples, real_world_samples, artwork_samples, dimension=(224, 224), verbose=False, testing=False):
    ...
    # create labels
    digital_labels = [0 for i in range(len(digital_sampled_images))]
    real_labels = [1 for i in range(len(real_sampled_images))]
    artwork_labels = [2 for i in range(len(artwork_sampled_images))] 
